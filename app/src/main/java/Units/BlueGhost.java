    ...
    public void changeMove(int change) {
        ...
        switch (change){
            case 1:
                ...
                AnimationDrawable blueGhostAn = (AnimationDrawable) this.getImageView().getBackground();
                blueGhostAn.start();
                xNew = imageView.getX();
                set[0].cancel();
            ...
            case 2:
                ...
                AnimationDrawable blueGhostAn2 = (AnimationDrawable) this.getImageView().getBackground();
                blueGhostAn2.start();
                xNew = imageView.getX();
                set[0].cancel();
                set[0] = new AnimatorSet();
            ...
            case 3:
                ...
                AnimationDrawable blueGhostAn3 = (AnimationDrawable) this.getImageView().getBackground();
                blueGhostAn3.start();
                xNew = imageView.getY();
                set[0].cancel();
                set[0] = new AnimatorSet();
            ...
            case 4:
                ...
                AnimationDrawable blueGhostAn4 = (AnimationDrawable) this.getImageView().getBackground();
                blueGhostAn4.start();
                xNew = imageView.getY();
                set[0].cancel();
                set[0] = new AnimatorSet();
